...
if [ -e ecoli-80.ctgStore/seqDB.v001.tig ]; then
  exists=true
else
  exists=false
fi
...
if [ -e ./ecoli-80.ctgStore ] ; then
  mv ./ecoli-80.ctgStore ../ecoli-80.ctgStore
fi
...
#
if [ -e ../ecoli-80.ctgStore -a \
   ! -e ../ecoli-80.ctgStore/seqDB.v001.sizes.txt ] ; then
  $bin/tgStoreDump \
    -S ../../ecoli-80.seqStore \
    -T ../ecoli-80.ctgStore 1 \
    -sizes -s 4800000 \
   > ../ecoli-80.ctgStore/seqDB.v001.sizes.txt
fi

if [ -e ../ecoli-80.ctgStore ] ; then
  cd ../ecoli-80.ctgStore
  cd -
fi
